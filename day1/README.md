...
- The dial starts by pointing at 50.
- The dial is rotated L68 to point at 82.   50 - 68 = -18, as it is < 0 we do 100 + -(18) = 82
- The dial is rotated L30 to point at 52.   82 - 30 = 52, as it is >= 0 and < 100  we don't do anything else
- The dial is rotated R48 to point at 0.    52 + 48 = 100, which becomes 0
- The dial is rotated L5 to point at 95.    0 - 5 = -5, as it is < 0 we do 100 + -(5) = 95
- The dial is rotated R60 to point at 55.   95 + 60 = 155, as it is > 100 we do 155 - 100  = 55
- The dial is rotated L55 to point at 0.    55 - 55 = 0, as it is >= 0 and < 100  we don't do anything else
- The dial is rotated L1 to point at 99.    0 - 1 = -1, as it is < 0 we do 100 + -(1) = 99
- The dial is rotated L99 to point at 0.    99 - 99 = 0, as it is >= 0 and < 100  we don't do anything else
- The dial is rotated R14 to point at 14.   0 + 14 = 14, as it is >= 0 and < 100  we don't do anything else
- The dial is rotated L82 to point at 32.   14 - 82 = -68, as it is < 0 we do 100 + -(68) = 32
...
- if L, substract
- if R, add
- if result < 0 do result = 100 + -(result)
